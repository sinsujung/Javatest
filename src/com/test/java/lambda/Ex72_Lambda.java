	...
	private static void m3() {
		...
		try {
			...
			BufferedReader reader 
				= new  BufferedReader(new FileReader("C:\\Users\\user\\Desktop\\q\\파일_입출력_문제\\성적.dat"));
...
//			});
	...
	private static void m2() {
		...
		//System.out.println(rnd.nextInt(100)); // 0-9까지 수
		...
		MyInterface m3 = () -> {
			System.out.println("람다식에서 구현한 메소드");// 자바에서는 람다식 쓰려면 앞에 인터페이스를 만들어줘야 쓸 수 있다~ 자바의 한계
		};
